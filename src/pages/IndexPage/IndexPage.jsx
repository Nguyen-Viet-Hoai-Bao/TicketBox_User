...
import { FloatButton, DatePicker, Radio, Row, Col, Select, Modal } from 'antd'; // Import Radio component
// import moment from 'moment';
import { Option } from "antd/es/mentions";
import { CustomRadioGroup, StyledVideo, RectangleStyle, BackgroundFB, CommentButton, SearchButton, SelectStyle, DatePickerStyle, FeedBack, ContainerFeedBack } from "./style";
...
const IndexPage = () => {
    ...
    useEffect(() => {
        if (!stationInitialized) {
            ...
            dispatch(updateStation({ departurePoint: '', arrivalPoint: '' }));
